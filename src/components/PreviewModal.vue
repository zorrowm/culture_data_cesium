<template>
  <teleport to="body">
    <div v-if="isVisible" class="preview-modal" @click.self="isVisible = false">
      <Icon icon="ant-design:close-circle-outlined" class="close-icon" @click="isVisible = false" />
      ...
      <div v-if="type === 'image'" class="toolbar">
        <Icon icon="ant-design:zoom-in-outlined" title="放大" @click="zoomInImg" />
        <Icon icon="ant-design:zoom-out-outlined" title="缩放" @click="zoomOutImg" />
        <Icon icon="ant-design:one-to-one-outlined" title="原始比例" @click="resetImg" />
        <Icon icon="ant-design:redo-outlined" title="旋转" @click="rotateImg" />
        <Icon icon="ant-design:download-outlined" title="下载" @click="saveImg(url)" />
      </div>
    </div>
  </teleport>
</template>
