<template>
  <div id="cesiumContainer" class="xgisViewerContainer"></div>
</template>
<script lang="ts">
//xgis-cesium样式
    ...
    onMounted( () => {
      ...
      if (Global.CesiumViewer) {
        ...
        xviewer.setBasicLayer('ARCGIS_IMG');
         const tileset3DURL0='https://3dtiles.gis.digsur.com/model/4a811ae1-322a-4ccd-bd47-ac1cae5809a5/tileset.json'
        Global.JiuBuilding1=Tiles3DLoader.load3DTilesLayer(tileset3DURL0,xviewer,'九眼楼长城-冬季','倾斜摄影',false);
        Global.JiuBuilding1.show=true;
        const tileset3DURL='https://3dtiles.gis.digsur.com/model/b3f6969e-f370-4001-9a65-2eda73f1ffb3/tileset.json';
        Global.JiuBuilding2=Tiles3DLoader.load3DTilesLayer(tileset3DURL,xviewer,'九眼楼长城-夏季','倾斜摄影',false);
         Global.JiuBuilding2.show=false;
